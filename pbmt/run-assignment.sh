...
SCRIPT_DIR=.
OUT_DIR=outputs
TRAIN_DATA=en-de/valid.en-de.low #en-de/train.en-de.low.filt
mkdir -p $OUT_DIR
...
python $SCRIPT_DIR/ibm1.py $TRAIN_DATA.de $TRAIN_DATA.en $OUT_DIR/alignment.txt
...
for f in valid; do #test blind; do
