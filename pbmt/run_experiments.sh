...
for f in valid test; do
  ...
  python $SCRIPT_DIR/decode.py $OUT_DIR/phrase-exp-fst.fst $OUT_DIR/ngram-exp-fst.fst $OUT_DIR/phrase-exp-fst.isym $OUT_DIR/ngram-exp-fst.isym < $DATA_DIR/$f.en-de.low.de > $OUT_DIR/$f.baseline.exp.en
